...
static size_t
_mirbooking_broker_get_target_site_index (MirbookingBroker *self, const MirbookingTargetSite *target_site)
{
    return target_site - (MirbookingTargetSite*) self->priv->target_sites->data;
}
